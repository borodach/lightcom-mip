...
public double GeoWidth 
{
    get 
    {
        ...
        PositionMapper.MapToGlobal (mapLeftUpper, global);
...
public void Move (int dx, int dy)
{
    ...
    GlobalPoint global = new GlobalPoint ();
    PositionMapper.MapToGlobal (mapLeftUpper, m_Position);
...
public GlobalPoint Position 
{
    ...
    set {m_Position = value; m_MapDataSource.FixPoint (m_Position);}
}    
