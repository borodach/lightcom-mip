...
namespace LightCom.MiP.Dispatcher.Controls
{
	...
	/// </summary>
	public class ClientList : System.Windows.Forms.UserControl, IPersistent
	{
		/// <summary>
		/// Обработчик событий при выполнение действий над мобильными клиентами
		/// </summary>
		public delegate void ClientListActionHandler(object sender, ClientDisplayInfo [] clients, ClientPage.ActionType atype);
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.allClientPage = new ClientPage();
			...
			this.allClientPage.DisplayClientAction += new Controls.ClientPage.DisplayClientActionHandler(this.page_DisplayClientAction);
			this.allClientPage.ChangeImage += new ClientPage.ChangeImageHandler(this.clientPage_ChangeImage);
			// 
			// tabImageList
			// 
		...
		private void page_DisplayClientAction(ClientPage page, ClientDisplayInfo [] sender, ClientPage.ActionType type)
		{
			switch(type)
			{
		...
		private void DeletePage(ClientPage page)
		{
			...
			{
				page.RemoveAll();
				page.ChangeImage -= new ClientPage.ChangeImageHandler(clientPage_ChangeImage);
				page.DisplayClientAction -= new ClientPage.DisplayClientActionHandler(page_DisplayClientAction);
