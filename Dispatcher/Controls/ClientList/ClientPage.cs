...
namespace LightCom.MiP.Dispatcher.Controls
{
	...
	/// 
	/// </summary>
	public class ClientPage : System.Windows.Forms.TabPage, IProperties, IPersistent
	{
...
//			ArrayList propList = new ArrayList();
		...
		public void Add(MobileClientInfo obj)
		{
			...
			if(cdi == DisplayClients.DefaultClientDisplayInfo)
			{
				...
				cdi.ClientDisplayInfoChanged += new ClientDisplayInfo.ClientDisplayInfoChangedHandler(UpdateClientDisplayInfo);
		...
		public void Add(ClientDisplayInfo obj)
		{
			...
			obj.ClientDisplayInfoChanged += new ClientDisplayInfo.ClientDisplayInfoChangedHandler(UpdateClientDisplayInfo);
