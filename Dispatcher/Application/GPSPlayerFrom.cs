...
using LightCom.UI;
using LightCom.MiP.Dispatcher.Controls;

namespace LightCom.MiP.Dispatcher.App
{
	/// <summary>
	...
	public class GPSPlayerForm : System.Windows.Forms.Form
	{
		private struct ObjectData
		{
			...
			public ClientDisplayInfo m_cdi;
			public DisplayInfoSettings m_gdis;
		...
		private MapWindowCtrl mapWindowCtrl1;
		private GPSPlayBackCtrl gpsPlayBackCtrl1;
		...
		public GPSPlayerForm()
		{
			...
			this.gpsPlayBackCtrl1.ChangeEventHandler = new PlaybackControl.TimeChangedEventHandler (PlaybackCtrlTimeChangedEventHandler);
			this.gpsPlayBackCtrl1.GPSDataCacheLoaded += new GPSPlayBackCtrl.GPSDataCacheLoadedHandler(gpsPlayBackCtrl1_GPSDataCacheLoaded);
			this.clientList1.ClientListAction += new ClientList.ClientListActionHandler(clientList1_ClientListAction);
		}
		...
		private void InitializeComponent()
		{
			...
			this.mapWindowCtrl1 = new MapWindowCtrl();
			...
			this.gpsPlayBackCtrl1 = new GPSPlayBackCtrl();
			this.clientList1 = new ClientList();
			...
			this.mapWindowCtrl1.MapMode = MapWindowCtrl.MapViewMode.Move;
			...
			this.gpsPlayBackCtrl1.DirectionMode = GPSDataPlayer.PlaybackDirectionEnum.pdForward;
			...
			this.gpsPlayBackCtrl1.PlaybackMode = GPSDataPlayer.PlaybackModeEnum.pmEventBased;
		...
		private void gpsPlayBackCtrl1_GPSDataCacheLoaded(object sender, GPSDataCache cache)
		{
            ...
            LightCom.MiP.Dispatcher.Common.MobileClientInfo mci;
			for (int i = 0; i < cache.Count; i ++)
			{
                mci = new LightCom.MiP.Dispatcher.Common.MobileClientInfo ();
...
//				m_objectsPosition [i].m_position = new ObjectPosition ();
		...
		/// <returns></returns>
		private ObjectData SetObjectData (ClientDisplayInfo cdi, bool showOnMap, bool groupSettings,
			DisplayInfoSettings dispGroupSettings)
		{
			for (int i = 0; i < m_objectsPosition.Length; i ++)
			{
		...
		private void clientList1_ClientListAction(object sender, ClientDisplayInfo[] clients, ClientPage.ActionType atype)
		{
			ClientPage page = (ClientPage) sender;
			switch (atype)
			{
				case ClientPage.ActionType.ShowOnMap:
				...
				case ClientPage.ActionType.UpdateClientInfo:
